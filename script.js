...
const helpContent = {
  shellType: {
    header: 'Kiểu pháo hoa',
    body: 'Random hội tụ tinh hoa'
  },
  shellSize: {
    header: 'Kích thước pháo hoa',
    body: 'Chọn 16 là bắn tùm lum'
  },
  quality: {
    header: 'chất lượng',
    body: 'Chất lượng cao có thể gây lag do tạo nhiều tia lửa, chọn thấp hơn để đỡ lag'
  },
  skyLighting: {
    header: 'Ánh sáng vùng trời',
    body: 'Pháo hoa tỏa sáng gây chói màn hình chọn Dim(để làm mờ) hoặc None(không chói)'
  },
  scaleFactor: {
    header: 'Tỷ lệ',
    body: 'Chọn tỷ lệ thích hợp với thiết bị đang sài'
  },
  autoLaunch: {
    header: 'Tự động bắn',
    body: 'Đang đi tự nhiên nghe cái đùng trái dừa rớt xuống mương'
  },
  finaleMode: {
    header: 'Click là bắn',
    body: 'Click để bắn pháo hoa tùy thích!'
  },
  hideControls: {
    header: 'Ẩn cài đặt',
    body: 'Ba thanh cài đặt trên màn hình sẽ được ẩn, yên tâm click vào thì vẫn hoạt động bình thường'
  },
  fullscreen: {
  ...
  longExposure: {
    header: 'Không nên chọn',
    body: 'Hiệu ứng không đẹp'
  }
};
